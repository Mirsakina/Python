...
#     a = int(input("Please enter divisible:\n>> "))
#     b = int(input("Please enter divider:\n>> "))
    
#     division_result = calculate(a, b)
#     print(f"The devision result = {division_result}")
...
#     with open(file_name, 'r') as file:            #Открываем файл в режиме чтения. with гарантирует, что файл закроется автоматически после работы с ним.
#         content = file.read()
...
# index = int(input("Please enter the index of the element you want to access:\n>> "))
...
# key = input("Plaese enter any key:\n>> ")
...
#     except FileNotFoundError:
#         print(f"The file which you entered was not found.")

# file_name = input("Please enter eny text:\n>> ")
...
#     print("Django module is not installed.")
